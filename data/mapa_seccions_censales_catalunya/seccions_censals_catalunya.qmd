...
<qgis version="3.34.3-Prizren">
  <identifier>ALQ_Secciones_2022_Web</identifier>
  <parentidentifier></parentidentifier>
  <language>SPA</language>
  <type>dataset</type>
  <title>ALQ_Secciones_2022_Web</title>
  <abstract>La base inicial es el Seccionado Censal del Censo Electoral del INE a 1 de enero de 2018, versión 1

Seccionado de edición para el inicio de los trabajos del Ciclo 9 de actualización</abstract>
  <keywords vocabulary="Search keys">
    <keyword>Secciones Censales</keyword>
    <keyword>Censo Electoral</keyword>
  </keywords>
  <contact>
    <name></name>
  ...
  <dates/>
  <fees></fees>
  <rights>La versión 1 se ha realizado mediante la revisión de los límites municipales remitidos por las Delegaciones durante el Ciclo 8 de trabajo.&#xd;
La geometría de las entidades es multiparte, incluyendose en la misma entidad cuantas geometrías disjuntas compongan su ámbito territorial.&#xd;
El trabajo se finalizó el 27 de Febrero de 2018&#xd;
</rights>
  <encoding></encoding>
  <crs>
  ...
  <extent>
    <spatial minx="-21.25850000000000151" crs="EPSG:3857" miny="27.47540000000000049" dimensions="2" maxz="0" minz="0" maxy="43.88629999999999853" maxx="4.76930000000000032"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
